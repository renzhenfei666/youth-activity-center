    ...
    <div class="articleList">
        <div class="container">
            ...
            class="table" ref="multipleTable">
                ...
                <el-table-column prop="payment" label="学费" align="center">
                </el-table-column>
                <el-table-column prop="feeDerate" :formatter="isFeeDerate" label="是否减免" align="center">
                </el-table-column>
                <el-table-column prop="cName" label="报名用户" :formatter="isCname" align="center">
                </el-table-column>
                <el-table-column prop="introducer" label="介绍人" align="center">
                </el-table-column>
                <el-table-column prop="createTime" :formatter="createTimeForMat" label="报名日期" align="center">
                </el-table-column>
                <el-table-column prop="status" label="报名状态" :formatter="isStatus" align="center">
                </el-table-column>
                <el-table-column prop="payStatus" label="付款状态" :formatter="isPayStatus" align="center">
                </el-table-column>
                <el-table-column prop="invoiceStatus" label="发票状态" :formatter="isInvoiceStatus" align="center">
                </el-table-column>
                <el-table-column label="操作" width="150" align="center">
                    <template slot-scope="scope">
                        <el-button type="text" icon="el-icon-edit" @click="modify(scope.row.id)">开票修改</el-button>
                    </template>
                    <div></div>
                </el-table-column>
            </el-table>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getPageInfo() {
                let p = {};
                p.sql = `select a.*,b.className,b.classTime,b.classCode,c.realName as cName,
                d.realName as dName,e.studentName,e.schoolName,e.gradeName,
                e.classNumber,f.feeDerate from activityEnroll as a 
            ...
            isCname(row, column, cellValue, index){
				if (cellValue != "0") {
					return cellValue;
				} else{
					return row.dName;
