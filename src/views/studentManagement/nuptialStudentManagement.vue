            ...
            class="table" ref="multipleTable">
                ...
                <el-table-column label="操作" width="300" align="center">
                    <template slot-scope="scope">
                        <el-button type="text" icon="el-icon-edit" @click="deleteConfirm(scope.row.id)" class="red">修改重复学生</el-button>
                    </template>
                </el-table-column>
            </el-table>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getPageInfo() {
                let p = {};
                p.sql = `select a.id,a.studentName,a.schoolName,a.gradeName,a.classNumber,a.mobile from student a`;
                p.everyPage = this.page.pageSize;
                p.currentPage = this.page.currentPage;
                p.whereStr = `where exists(select 1 from student b where b.id != a.id and 
                b.studentName=a.studentName and b.schoolName=a.schoolName and b.gradeName=a.gradeName 
                and b.classNumber=a.classNumber) and a.status =1`;
                p.orderStr = "order by a.studentName asc";
                console.log(p);  
