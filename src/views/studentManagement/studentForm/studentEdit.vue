<template>
    <div>
        <el-dialog title="注册学生" :visible.sync="editShow" :center="center" top="10vh" :show-close="close" :close-on-click-modal="false">
...
export default {
    ...
    methods: {
        ...
        getDetailById() {
            ...
            p.id = this.id;
            console.log(p);  
            this.api.getDetailById("student",p)
            .then(result => {
                console.log(result);
